...
## Project Structure
    ...
    ├── event_management_te_38031  # Django project configurations
...
1. Clone this repo and `cd event_management_te_38031`
...
2. Clone this repo and `cd event_management_te_38031`
